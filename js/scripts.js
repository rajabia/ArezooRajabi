...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Load More Portfolio */    
        ...
        $("div.portfolio").slice(0, 20).show();
          $("#load-more-portfolio").on('click', function (e) {
             e.preventDefault();
             $("div.portfolio:hidden").slice(0, 10).slideDown(3000);
             if ($("div.portfolio:hidden").length == 0) {
             $('#portfolio-end-message').html('<div class="end">End</div>').fadeIn(8000);
             $("#load-more-portfolio").fadeOut(1000);
              }
             });
